              ...
              <DocumentPreviewRow document={doc} previewDocuments={filtered}>
                {doc.canDelete && (
                  <button
                    ...
                    className="inline-flex size-10 items-center justify-center rounded-lg text-muted-foreground hover:bg-red-100 hover:text-red-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/30 dark:hover:bg-red-900/30 disabled:opacity-50"
                  >
                    {deleting === doc._id ? (
